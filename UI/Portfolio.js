function BlogDisplay(){
  ...
  allBlogs.forEach((aBlog,index) =>{
    ...
    <div class="blogDate">${aBlog.bDate}</div>
  ...
  document.querySelector('.js-blogs').innerHTML = `<div class="card-wrapper swiper-wrapper">
                ${landingBlogs}
  </div>`;
}
...
const blogButton = document.querySelectorAll('.js-blog-but');
  ...
  <div class="blogLeft">
      <div class="topDesc">
          ...
          <div class="bllDesc">
              ...
              <div class="blDate">${blogToView.bDate}</div>
              <div class="blIcon">
                  <button class="like-but js-like-but lik-but-${index}" onclick="likingBlog(${index})">
