      ...
      allBlogs.forEach((aBlog, index) => {
        ...
        landingBlogs += `
            ...
            <div class="justifyBlog">
              ...
              <div class="blogInteractions">
                <div class="blogFeedback">
                  <button class="like-but js-like-but lik-but-${index}" onclick="handleLikeButtonClick(${index}, '${
          aBlog._id
        }')">
                    <div>
                      <img class="thumb" src="${
          ...
          aBlog.bNumOfLike
                  ...
                  <button class="like-but js-comment-button" onclick="viewAndScroll(${index})">
                    <img class="thumb" src="Images/Comment.svg" alt="">
                  </button>
                </div>
                <button onclick="viewBlogDetails(${index})" class="blogBut js-blog-but">
                  View More <img src="Images/rightt arrow.svg" alt="">
                </button>
              </div>
            </div>
          </div>
...
async function toggleLike(index, blogId) {
  ...
  if (isBlogLiked(blogId)) {
    ...
    const updatedLikes =
      parseInt(likeButton.nextElementSibling.textContent) - 1;
  ...
  <div class="topDesc">
    ...
    <div class="bllDesc">
      ...
      <div class="blIcon">
        ...
        >
          <img class="com-but" src="Images/Comment.svg" alt="" />
        </button>
      </div>
    </div>
  </div>
...
function downloadFile() {
  const fileUrl =
    "https://res.cloudinary.com/da4rqn95a/image/upload/v1715461146/ndstcdq4kmf8ohnlvdao.pdf";
